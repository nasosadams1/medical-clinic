...
export const LESSON_CATALOG: LessonCatalogEntry[] = [
  { id: "python-variables-1", title: "Python Variables - Introduction", language: "python", index: 0, languageIndex: 0 },
  { id: "python-variables-2", title: "Python Variables - Types and Operations", language: "python", index: 1, languageIndex: 1 },
  { id: "python-type-casting", title: "Python Type Casting", language: "python", index: 2, languageIndex: 2 },
  { id: "python-comparison-operators", title: "Python Comparison Operators", language: "python", index: 3, languageIndex: 3 },
  { id: "python-logical-operators", title: "Python Logical Operators", language: "python", index: 4, languageIndex: 4 },
  { id: "python-if-statements", title: "Python If Statements", language: "python", index: 5, languageIndex: 5 },
  { id: "python-string-methods", title: "Python String Methods", language: "python", index: 6, languageIndex: 6 },
  { id: "python-while-loops-conditions", title: "Python While Loops", language: "python", index: 7, languageIndex: 7 },
  { id: "python-for-loops-nested", title: "Python For and Nested Loops", language: "python", index: 8, languageIndex: 8 },
  { id: "python-dictionaries", title: "Python Dictionaries", language: "python", index: 9, languageIndex: 9 },
  { id: "python-if-else", title: "Python If...Else", language: "python", index: 10, languageIndex: 10 },
  { id: "python-match", title: "Python Match", language: "python", index: 11, languageIndex: 11 },
  { id: "python-operators", title: "Python Operators", language: "python", index: 12, languageIndex: 12 },
  { id: "python-while-loops-basics", title: "Python While Loops", language: "python", index: 13, languageIndex: 13 },
  { id: "python-for-loops-basics", title: "Python For Loops", language: "python", index: 14, languageIndex: 14 },
  { id: "python-arrays", title: "Python Arrays", language: "python", index: 15, languageIndex: 15 },
  { id: "python-lists", title: "Python Lists", language: "python", index: 16, languageIndex: 16 },
  { id: "python-tuples", title: "Python Tuples", language: "python", index: 17, languageIndex: 17 },
  { id: "python-strings-methods", title: "Python Strings", language: "python", index: 18, languageIndex: 18 },
  { id: "python-lists-methods", title: "Python List  Methods", language: "python", index: 19, languageIndex: 19 },
  { id: "python-sets-methods", title: "Python Set Methods", language: "python", index: 20, languageIndex: 20 },
  { id: "python-dictionaries-methods", title: "Python Dictionary Methods", language: "python", index: 21, languageIndex: 21 },
  { id: "python-functions", title: "Python Functions", language: "python", index: 22, languageIndex: 22 },
  { id: "python-lambda", title: "Python Lambda", language: "python", index: 23, languageIndex: 23 },
  { id: "python-oop", title: "Python OOP", language: "python", index: 24, languageIndex: 24 },
  { id: "python-classes-objects", title: "Python Classes and Objects", language: "python", index: 25, languageIndex: 25 },
  { id: "python-inheritance", title: "Python Inheritance", language: "python", index: 26, languageIndex: 26 },
  { id: "python-iterators", title: "Python Iterators (Classes)", language: "python", index: 27, languageIndex: 27 },
  { id: "python-polymorphism", title: "Python Polymorphism (Classes)", language: "python", index: 28, languageIndex: 28 },
  { id: "python-scope", title: "Python Scope", language: "python", index: 29, languageIndex: 29 },
  { id: "python-modules", title: "Python Modules", language: "python", index: 30, languageIndex: 30 },
  { id: "python-dates", title: "Python Dates", language: "python", index: 31, languageIndex: 31 },
  { id: "python-math", title: "Python Math", language: "python", index: 32, languageIndex: 32 },
  { id: "python-json", title: "Python JSON", language: "python", index: 33, languageIndex: 33 },
  { id: "python-pip", title: "Python PIP", language: "python", index: 34, languageIndex: 34 },
  { id: "python-try-except", title: "Python Try...Except", language: "python", index: 35, languageIndex: 35 },
  { id: "python-string-formatting", title: "Python String Formatting", language: "python", index: 36, languageIndex: 36 },
  { id: "python-user-input", title: "Python User Input", language: "python", index: 37, languageIndex: 37 },
  { id: "python-read-files", title: "Python Read Files", language: "python", index: 38, languageIndex: 38 },
  { id: "python-write-files", title: "Python Write/Create Files", language: "python", index: 39, languageIndex: 39 },
  { id: "python-delete-files", title: "Python Delete Files", language: "python", index: 40, languageIndex: 40 },
  { id: "python-modules-libraries", title: "Python Modules & Libraries", language: "python", index: 41, languageIndex: 41 },
  { id: "python-random-numbers", title: "Python Random Numbers", language: "python", index: 42, languageIndex: 42 },
  { id: "numpy-tutorial", title: "NumPy Tutorial", language: "python", index: 43, languageIndex: 43 },
  { id: "scipy-tutorial-1", title: "SciPy Basics & Linear Algebra", language: "python", index: 44, languageIndex: 44 },
  { id: "scipy-tutorial-2", title: "SciPy Statistics & Optimization", language: "python", index: 45, languageIndex: 45 },
  { id: "pandas-tutorial-1", title: "Pandas Series & DataFrames", language: "python", index: 46, languageIndex: 46 },
  { id: "pandas-tutorial-2", title: "Pandas Data Operations & Analysis", language: "python", index: 47, languageIndex: 47 },
  { id: "mongodb-tutorial-1", title: "MongoDB Basics & CRUD", language: "python", index: 48, languageIndex: 48 },
  { id: "mongodb-tutorial-2", title: "MongoDB Updating & Deleting", language: "python", index: 49, languageIndex: 49 },
