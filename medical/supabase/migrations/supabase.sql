...
\restrict BdI4uq1Jjoy7Gc2uGcaFiAKrB0BWGxWiA2VgCWG6fUOANuXcAgoCOom93fU36gu
...
CREATE TABLE public.matches (
    ...
    CONSTRAINT matches_player_a_score_check CHECK ((player_a_score >= 0)),
    CONSTRAINT matches_player_b_score_check CHECK ((player_b_score >= 0)),
...
ALTER TABLE ONLY public.matches
    ADD CONSTRAINT matches_problem_id_fkey FOREIGN KEY (problem_id) REFERENCES public.problems(id) ON DELETE SET NULL;
...
--
-- Name: problems Anyone can view active problems; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Anyone can view active problems" ON public.problems FOR SELECT TO authenticated USING ((is_active = true));
...
CREATE POLICY "System can insert matches" ON public.matches FOR INSERT TO authenticated WITH CHECK (true);


--
-- Name: matches System can update matches; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "System can update matches" ON public.matches FOR UPDATE TO authenticated USING (true);
...
--
-- Name: code_snapshots Users can insert their own snapshots; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can insert their own snapshots" ON public.code_snapshots FOR INSERT TO authenticated WITH CHECK ((user_id = auth.uid()));


--
-- Name: submissions Users can insert their own submissions; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can insert their own submissions" ON public.submissions FOR INSERT TO authenticated WITH CHECK ((user_id = auth.uid()));
...
--
-- Name: code_snapshots Users can view snapshots from their matches; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can view snapshots from their matches" ON public.code_snapshots FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.matches
  WHERE ((matches.id = code_snapshots.match_id) AND ((matches.player_a_id = auth.uid()) OR (matches.player_b_id = auth.uid()))))));


--
-- Name: submissions Users can view submissions from their matches; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can view submissions from their matches" ON public.submissions FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.matches
  WHERE ((matches.id = submissions.match_id) AND ((matches.player_a_id = auth.uid()) OR (matches.player_b_id = auth.uid()))))));


--
-- Name: matches Users can view their own matches; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can view their own matches" ON public.matches FOR SELECT TO authenticated USING (((player_a_id = auth.uid()) OR (player_b_id = auth.uid())));
...
\unrestrict BdI4uq1Jjoy7Gc2uGcaFiAKrB0BWGxWiA2VgCWG6fUOANuXcAgoCOom93fU36gu
