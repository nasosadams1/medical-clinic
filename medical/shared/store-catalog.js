export const STORE_ITEMS = Object.freeze([
  ...
  },
  {
    ...
    billingIntervalCount: 1,
    name: 'Teams',
    description: 'Team dashboard, assignments, leaderboards, and skill-check analytics for one cohort of up to 25 learners.',
    stripeAmountCents: 29900,
    currency: 'usd',
    durationDays: 30,
    planName: 'Teams',
    planScope: 'team',
  ...
  },
  {
    ...
    billingIntervalCount: 1,
    name: 'Teams Growth',
    description: 'Multi-cohort team billing with expanded analytics, progress-over-time reporting, and priority onboarding.',
    stripeAmountCents: 99900,
    currency: 'usd',
    durationDays: 30,
